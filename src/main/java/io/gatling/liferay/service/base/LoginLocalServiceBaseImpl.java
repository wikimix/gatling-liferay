...
public abstract class LoginLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LoginLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	@Override
	public Login deleteLogin(long userId) throws PortalException {
	...
	@Override
	public Login fetchLogin(long userId) {
	 ...
	 */
	@Override
	public Login getLogin(long userId) throws PortalException {
	 ...
	 */
	public LoginLocalService getLoginLocalService() {
	 ...
	 */
	public void setLoginLocalService(LoginLocalService loginLocalService) {
	...
	@BeanReference(type = LoginLocalService.class)
