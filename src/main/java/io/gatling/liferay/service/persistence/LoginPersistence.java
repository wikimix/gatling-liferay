...
public interface LoginPersistence extends BasePersistence<Login> {
    ...
    */
     ...
     * @throws SystemException if a system exception occurred
     */
	List<Login> findAll(int start, int end, OrderByComparator<Login> orderByComparator);

	List<Login> findAll(int start, int end, OrderByComparator<Login> orderByComparator, boolean retrieveFromCache);
}
