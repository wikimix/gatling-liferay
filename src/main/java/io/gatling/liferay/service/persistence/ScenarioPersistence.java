...
public interface ScenarioPersistence extends BasePersistence<Scenario> {
    ...
    */
	...
	List<Scenario> findBySimulationId(long simulation_id, int start, int end,
	...
	/**
	    ...
	    * @throws SystemException if a system exception occurred
	    */
	Scenario findBySimulationId_First(long simulation_id, OrderByComparator<Scenario> orderByComparator)
			throws NoSuchScenarioException;
	...
	/**
	    ...
	    * @throws SystemException if a system exception occurred
	    */
	Scenario fetchBySimulationId_First(long simulation_id, OrderByComparator<Scenario> orderByComparator);
	 ...
	 /**
	    ...
	    * @throws SystemException if a system exception occurred
	    */
	Scenario findBySimulationId_Last(long simulation_id, OrderByComparator<Scenario> orderByComparator)
			throws NoSuchScenarioException;
	  ...
	  /**
	    ...
	    * @throws SystemException if a system exception occurred
	    */
	Scenario fetchBySimulationId_Last(long simulation_id, OrderByComparator<Scenario> orderByComparator);
	 ...
	 /**
	    ...
	    * @throws SystemException if a system exception occurred
	    */
	Scenario[] findBySimulationId_PrevAndNext(long scenario_id, long simulation_id,
			OrderByComparator<Scenario> orderByComparator) throws NoSuchScenarioException;
	 ...
	 /**
	    ...
	    * @throws SystemException if a system exception occurred
	    */
	List<Scenario> findAll(int start, int end, OrderByComparator<Scenario> orderByComparator);
