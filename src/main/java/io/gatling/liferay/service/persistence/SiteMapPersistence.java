...
public interface SiteMapPersistence extends BasePersistence<SiteMap> {
    ...
    */
	...
	List<SiteMap> findAll(int start, int end, OrderByComparator<SiteMap> orderByComparator);

	List<SiteMap> findAll(int start, int end, OrderByComparator<SiteMap> orderByComparator, boolean retrieveFromCache);
}
